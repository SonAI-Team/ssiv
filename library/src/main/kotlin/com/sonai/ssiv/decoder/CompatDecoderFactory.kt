 ...
 */
class CompatDecoderFactory<T> : DecoderFactory<T> {
     ...
     * @param clazz a class that implements [SSIVImageDecoder] or [ImageRegionDecoder].
     */
     ...
     */
    constructor(clazz: Class<out T>, bitmapConfig: Bitmap.Config?) {
        this.clazz = clazz

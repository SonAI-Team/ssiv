...
First off, thank you for considering contributing to Subsampling Scale Image View! It's people like
you that make it a great tool for the Android community.
...
* Keep logic decoupled. Prefer adding logic to internal helper classes (`TileManager`, `MathUtils`,
  etc.) rather than bloating `SubsamplingScaleImageView.kt`.

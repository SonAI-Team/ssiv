...
class ImageDisplayRegionFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        imageView.setBitmapDecoderFactory(CompatDecoderFactory(SkiaSSIVImageDecoder::class.java, Bitmap.Config.ARGB_8888))
        imageView.setRegionDecoderFactory(CompatDecoderFactory(SkiaImageRegionDecoder::class.java, Bitmap.Config.ARGB_8888))
